...
private:
    ...
    static ExternalVariable *createObjectsArray(const QString &varName, const dataFlowFlag direction);
    static ExternalVariable *createParticleSystem(const QString &varName, const dataFlowFlag direction);
};
